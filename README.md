...
# Activate the environment by pasting the following to the terminal.
...
# Where it states: 
        ...
        idx = "ref/HCMV_idx.1.bt2"
# Note: If you want to run the code using the don_data and not the test_data, the above changes do not have to be made; both are included in the pipeline. 
# Additionally, the user can change the name of the final file. 
# Note: The instructions on where to make the necessary changes have been included in the comments of the snakefile. 
...
# Once the pipline is is complete there will be message at the bottom after running the above code stating: 
[ day/time ]
Finished job 0.
